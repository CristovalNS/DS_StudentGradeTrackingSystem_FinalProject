...
public class ArrayListDriver {
    private static ArrayList<DS_ArrayListTracker> classes;
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            System.out.println("\nStudent Grade Tracking System Simulation Launched - DataStructure: ArrayList");
            System.out.println("******************************");
    ...
    private static void addClass() {
        ...
        DS_ArrayListTracker classTracker = new DS_ArrayListTracker();
    ...
    private static void removeClass() {
        ...
        if (index >= 0 && index < classes.size()) {
            DS_ArrayListTracker classTracker = classes.get(index);
    ...
    private static void addStudentAndGrade(DS_ArrayListTracker classTracker) {
        Scanner scanner = new Scanner(System.in);
    ...
    private static void addStudent(DS_ArrayListTracker classTracker) {
        Scanner scanner = new Scanner(System.in);
    ...
    private static void editStudentGrade(DS_ArrayListTracker classTracker) {
        Scanner scanner = new Scanner(System.in);
    ...
    private static void removeStudent(DS_ArrayListTracker classTracker) {
        Scanner scanner = new Scanner(System.in);
    ...
    private static void displayClasses() {
        int index = 1;
        for (DS_ArrayListTracker classTracker : classes) {
